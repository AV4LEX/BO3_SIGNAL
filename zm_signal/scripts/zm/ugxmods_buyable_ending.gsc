...
#define ENDGAME_COST					30000 //how much should it cost to end the game?
#define ENDGAME_CUSTOM_GAME_OVER 		"MISSION ACCOMPLISHED ! ?" //Do you want to replace the "GAME OVER" text? Set it here. If you want the default game over text from zombies, set this to blank.
#define ENDGAME_CUSTOM_TRIGGER_HINT		"Press &&1 to finish the mission!" //Customize the endgame trigger hintstring here. Cost will be appended automatically.
