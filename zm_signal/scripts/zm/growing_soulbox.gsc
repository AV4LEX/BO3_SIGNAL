...
function RewardPlayers()
{
	...
	if(isdefined(self))
	{
		...
		level.amountComplete -= 1;
		if(level.amountComplete > 1)
		{
			IPrintLnBold("There are "+level.amountComplete+" soul boxes left");
		}
		else
		{
			IPrintLnBold("There is "+level.amountComplete+" soul box left");
		}
	}
