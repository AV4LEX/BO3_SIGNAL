...
#precache( "fx", "dlc1/castle/fx_dragon_head_dest_impact" );
#precache( "fx", "dlc1/castle/fx_dragon_head_eye_glow" );
#precache( "fx", "dlc1/castle/fx_dragon_head_eye_glow_sm" );
#precache( "fx", "dlc1/castle/fx_dragon_head_intro" );
#precache( "fx", "dlc1/castle/fx_dragon_head_mouth_blood" );
#precache( "fx", "dlc1/castle/fx_dragon_head_mouth_drips" );
#precache( "fx", "dlc1/castle/fx_dragon_head_mouth_drips_tongue" );
#precache( "fx", "dlc1/castle/fx_dragon_head_mouth_fire" );
#precache( "fx", "dlc1/castle/fx_dragon_head_mouth_fire_sm" );
#precache( "fx", "dlc1/castle/fx_dragon_head_neck_edge" );
#precache( "fx", "dlc1/castle/fx_dragon_head_nose_smoke" );
...
function create_anim_references_on_server()
{
	...
	var_92a5d68e = "o_zm_dlc1_dragonhead_consume_pre_eat_l_2_r";
	var_799790fe = "o_zm_dlc1_dragonhead_consume_pre_eat_r_2_l";
	var_917cf7dd = [];
...
function zombie_soul_catcher_death(einflictor, attacker, idamage, smeansofdeath, weapon, vdir, shitloc, psoffsettime)
{
	...
	if(n_eating_anim == 3)
	{
		var_a8b20b82 = (getanimlength("o_zm_dlc1_dragonhead_consume_pre_eat_f")) + (getanimlength("ai_zm_dlc1_dragonhead_consume_zombie_align_f"));
	}
	else
	{
		if(n_eating_anim == 4)
		{
			var_a8b20b82 = (getanimlength("o_zm_dlc1_dragonhead_consume_pre_eat_r")) + (getanimlength("ai_zm_dlc1_dragonhead_consume_zombie_align_r"));
		}
		else
		{
			var_a8b20b82 = (getanimlength("o_zm_dlc1_dragonhead_consume_pre_eat_l")) + (getanimlength("ai_zm_dlc1_dragonhead_consume_zombie_align_l"));
		}
	}
...
function soul_catcher_check()
{
	...
	else if(level.n_soul_catchers_charged >= level.soul_catchers.size)
	{
		...
		//IPrintLnBold("ACTIVATED");
		level notify("Dragonheads_Filled");
...
function dragon_door()
{	

	level.dragon_door = GetEntArray("dragon_door", "targetname");

	level waittill("Dragonheads_Filled");

	IPrintLnBold("a door has opened... ");

	foreach(model in level.dragon_door)
	{
		model MoveZ(-500,3);
	}
