...
#precache( "client_fx", "dlc1/castle/fx_dragon_head_dest_impact" );
#precache( "client_fx", "dlc1/castle/fx_dragon_head_eye_glow" );
#precache( "client_fx", "dlc1/castle/fx_dragon_head_eye_glow_sm" );
#precache( "client_fx", "dlc1/castle/fx_dragon_head_intro" );
#precache( "client_fx", "dlc1/castle/fx_dragon_head_mouth_blood" );
#precache( "client_fx", "dlc1/castle/fx_dragon_head_mouth_drips" );
#precache( "client_fx", "dlc1/castle/fx_dragon_head_mouth_drips_tongue" );
#precache( "client_fx", "dlc1/castle/fx_dragon_head_mouth_fire" );
#precache( "client_fx", "dlc1/castle/fx_dragon_head_mouth_fire_sm" );
#precache( "client_fx", "dlc1/castle/fx_dragon_head_neck_edge" );
#precache( "client_fx", "dlc1/castle/fx_dragon_head_nose_smoke" );
