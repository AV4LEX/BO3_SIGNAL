...
#namespace buyable_ending_2; 

function init()
{
	// ============ CHANGE YOUR SETTINGS BELOW ================
	level.end_game_cost = 30000; 												// This line is how much it will cost to end your game
	...
	level.end_game_message = "MISSION ACCOMPLISHED ! THANKS FOR PLAYING !";			// This is the message the player will see at the end of the game 
...
function main()
{
	trig = GetEnt( "end_game_trig_2", "targetname" ); 
